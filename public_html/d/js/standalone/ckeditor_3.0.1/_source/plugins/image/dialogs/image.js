				...
				},
				{
					...
					[

                                                {
                                                        ...
                                                        id : 'sizeSmall',
                                                        style: "width:80px",
                                                        label : "Размер маленького изображения:",
                                                        default: "500",
							size : 4,
                                                        validate : CKEDITOR.dialog.validate.number('Must be numeric'),
                                			onChange : function()
                                			{
								$.post("/?upload", { sizeSmall: this.getValue() } );
                                                        }
                                                },
                                                {
                                                        type : 'checkbox',
                                                        ...
                                                        onChange : function()
                                                        {
                                                                $.post("/?upload", { cropSmall: this.getValue() } );
                                                        }
                                                },
                                                {
                                                        type : 'checkbox',
                                                        ...
                                                        onChange : function()
                                                        {
                                                                $.post("/?upload", { desaturateSmall: this.getValue() } );
                                                        }
                                                },
                                                {
                                                        type : 'checkbox',
                                                        ...
                                                        onChange : function()
                                                        {
                                                                $.post("/?upload", { sharpenSmall: this.getValue() } );
                                                        }
                                                },
                                                {
                                                        type : 'text',
                                                        id : 'sizeBig',
                                                        style: "width:80px",
                                                        label : "Размеp большого изображения:",
                                                        default: "1280",
                                                        size : 4,
                                                        validate : CKEDITOR.dialog.validate.number('Must be numeric'),
                                                        onChange : function()
                                                        {      
								$.post("/?upload", { sizeBig: this.getValue() } );
                                                        }
                                                },
                                                {
                                                        type : 'checkbox',
                                                        ...
                                                        onChange : function()
                                                        {
                                                                $.post("/?upload", { cropBig: this.getValue() } );
                                                        }
                                                },
                                                {
                                                        type : 'checkbox',
                                                        ...
                                                        onChange : function()
                                                        {
                                                                $.post("/?upload", { desaturateBig: this.getValue() } );
                                                        }
                                                },
                                                {
                                                        type : 'checkbox',
                                                        ...
                                                        onChange : function()
                                                        {
                                                                $.post("/?upload", { sharpenBig: this.getValue() } );
                                                        }
                                                },
						{
							type : 'file',
