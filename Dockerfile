...
CMD service memcached start && service mariadb start &&service apache2 start && service nginx start && mysqladmin --wait=30 ping && mysql -u root < /tmp/sitebrush.sql && /tmp/ssmtp.sh && while true; do sleep 1; done
