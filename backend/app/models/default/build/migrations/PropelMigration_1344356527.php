 ...
 * up to version 1344356527.
 * Generated on 2012-08-07 20:22:07 by root
 */
class PropelMigration_1344356527
{
...
ALTER TABLE `domain` CHANGE `title` `dnszonedata` TEXT NOT NULL;
...
ALTER TABLE `domain` CHANGE `dnszonedata` `title` TEXT NOT NULL;
