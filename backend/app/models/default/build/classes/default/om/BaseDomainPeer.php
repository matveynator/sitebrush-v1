...
/**
 * Base static class for performing query and update operations on the 'domain' table.
 *
 * 
 *
...
abstract class BaseDomainPeer {
	...
	const CLASS_DEFAULT = 'default.Domain';
	...
	/** the column name for the DNSZONEDATA field */
	const DNSZONEDATA = 'domain.DNSZONEDATA';

	/** the column name for the CNAMESECRET field */
	const CNAMESECRET = 'domain.CNAMESECRET';

	/** the column name for the EMAILSECRET field */
	const EMAILSECRET = 'domain.EMAILSECRET';

	/** the column name for the FREEZED field */
	const FREEZED = 'domain.FREEZED';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'DNSZoneData', 'CnameSecret', 'EmailSecret', 'Freezed', 'Status', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'dNSZoneData', 'cnameSecret', 'emailSecret', 'freezed', 'status', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::DNSZONEDATA, self::CNAMESECRET, self::EMAILSECRET, self::FREEZED, self::STATUS, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'DNSZONEDATA', 'CNAMESECRET', 'EMAILSECRET', 'FREEZED', 'STATUS', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'dnszonedata', 'cnamesecret', 'emailsecret', 'freezed', 'status', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'DNSZoneData' => 2, 'CnameSecret' => 3, 'EmailSecret' => 4, 'Freezed' => 5, 'Status' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'dNSZoneData' => 2, 'cnameSecret' => 3, 'emailSecret' => 4, 'freezed' => 5, 'status' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::DNSZONEDATA => 2, self::CNAMESECRET => 3, self::EMAILSECRET => 4, self::FREEZED => 5, self::STATUS => 6, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'DNSZONEDATA' => 2, 'CNAMESECRET' => 3, 'EMAILSECRET' => 4, 'FREEZED' => 5, 'STATUS' => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'dnszonedata' => 2, 'cnamesecret' => 3, 'emailsecret' => 4, 'freezed' => 5, 'status' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(DomainPeer::DNSZONEDATA);
			$criteria->addSelectColumn(DomainPeer::CNAMESECRET);
			$criteria->addSelectColumn(DomainPeer::EMAILSECRET);
			$criteria->addSelectColumn(DomainPeer::FREEZED);
			$criteria->addSelectColumn(DomainPeer::STATUS);
		} else {
			$criteria->addSelectColumn($alias . '.ID');
			$criteria->addSelectColumn($alias . '.NAME');
			$criteria->addSelectColumn($alias . '.DNSZONEDATA');
			$criteria->addSelectColumn($alias . '.CNAMESECRET');
			$criteria->addSelectColumn($alias . '.EMAILSECRET');
			$criteria->addSelectColumn($alias . '.FREEZED');
	...
	/**
	 * Method to DELETE all rows from the domain table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
