...
/**
 * Base class that represents a row from the 'post_template' table.
 *
 * 
 *
 * @package    propel.generator.default.om
 */
abstract class BasePostTemplate extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'PostTemplatePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        PostTemplatePeer
	 */
	 ...
	 * @return     PostTemplate The current object (for fluent API support)
	 */
	public function setPostId($v)
	{
		...
		if ($this->post_id !== $v) {
			$this->post_id = $v;
			$this->modifiedColumns[] = PostTemplatePeer::POST_ID;
		}
	...
	public function setTemplateId($v)
	{
		...
		if ($this->template_id !== $v) {
			$this->template_id = $v;
			$this->modifiedColumns[] = PostTemplatePeer::TEMPLATE_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = PostTemplatePeer::NUM_COLUMNS - PostTemplatePeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating PostTemplate object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = PostTemplatePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				PostTemplatePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$affectedRows += PostTemplatePeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = PostTemplatePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = PostTemplatePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['PostTemplate'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['PostTemplate'][serialize($this->getPrimaryKey())] = true;
		$keys = PostTemplatePeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PostTemplatePeer::POST_ID)) $criteria->add(PostTemplatePeer::POST_ID, $this->post_id);
		if ($this->isColumnModified(PostTemplatePeer::TEMPLATE_ID)) $criteria->add(PostTemplatePeer::TEMPLATE_ID, $this->template_id);
	...
	{
		$criteria = new Criteria(PostTemplatePeer::DATABASE_NAME);
		$criteria->add(PostTemplatePeer::POST_ID, $this->post_id);
		$criteria->add(PostTemplatePeer::TEMPLATE_ID, $this->template_id);
	...
	{
		return (null === $this->getPostId()) && (null === $this->getTemplateId());
	}
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of PostTemplate (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     PostTemplate Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     PostTemplatePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new PostTemplatePeer();
		}
		return self::$peer;
	}
	...
	public function getPost(PropelPDO $con = null)
	{
		if ($this->aPost === null && ($this->post_id !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aPost->addPostTemplates($this);
			 */
		}
		return $this->aPost;
	}
	 ...
	 * @throws     PropelException
	 */
	public function getTemplate(PropelPDO $con = null)
	{
		if ($this->aTemplate === null && ($this->template_id !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aTemplate->addPostTemplates($this);
			 */
		}
	...
	{
		return (string) $this->exportTo(PostTemplatePeer::DEFAULT_STRING_FORMAT);
	}
