...
abstract class BaseTemplatePeer {
	...
	const CLASS_DEFAULT = 'default.Template';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Data', 'Status', 'Domain', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'data', 'status', 'domain', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::DATA, self::STATUS, self::DOMAIN, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'DATA', 'STATUS', 'DOMAIN', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'data', 'status', 'domain', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Data' => 2, 'Status' => 3, 'Domain' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'data' => 2, 'status' => 3, 'domain' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::DATA => 2, self::STATUS => 3, self::DOMAIN => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'DATA' => 2, 'STATUS' => 3, 'DOMAIN' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'data' => 2, 'status' => 3, 'domain' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(TemplatePeer::DOMAIN);
		} else {
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = TemplatePeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + TemplatePeer::NUM_COLUMNS;
		} else {
