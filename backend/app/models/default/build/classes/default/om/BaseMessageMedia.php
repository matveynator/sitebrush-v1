...
/**
 * Base class that represents a row from the 'message_media' table.
 *
 * 
 *
 * @package    propel.generator.default.om
 */
abstract class BaseMessageMedia extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'MessageMediaPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        MessageMediaPeer
	 */
	 ...
	 * @return     MessageMedia The current object (for fluent API support)
	 */
	public function setMessageId($v)
	{
		...
		if ($this->message_id !== $v) {
			$this->message_id = $v;
			$this->modifiedColumns[] = MessageMediaPeer::MESSAGE_ID;
		}
	...
	public function setMediaId($v)
	{
		...
		if ($this->media_id !== $v) {
			$this->media_id = $v;
			$this->modifiedColumns[] = MessageMediaPeer::MEDIA_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = MessageMediaPeer::NUM_COLUMNS - MessageMediaPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating MessageMedia object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = MessageMediaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				MessageMediaPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$affectedRows += MessageMediaPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = MessageMediaPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = MessageMediaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['MessageMedia'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['MessageMedia'][serialize($this->getPrimaryKey())] = true;
		$keys = MessageMediaPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MessageMediaPeer::MESSAGE_ID)) $criteria->add(MessageMediaPeer::MESSAGE_ID, $this->message_id);
		if ($this->isColumnModified(MessageMediaPeer::MEDIA_ID)) $criteria->add(MessageMediaPeer::MEDIA_ID, $this->media_id);
	...
	{
		$criteria = new Criteria(MessageMediaPeer::DATABASE_NAME);
		$criteria->add(MessageMediaPeer::MESSAGE_ID, $this->message_id);
		$criteria->add(MessageMediaPeer::MEDIA_ID, $this->media_id);
	...
	{
		return (null === $this->getMessageId()) && (null === $this->getMediaId());
	}
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of MessageMedia (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     MessageMedia Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     MessageMediaPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new MessageMediaPeer();
		}
		return self::$peer;
	}
	...
	public function getMessage(PropelPDO $con = null)
	{
		if ($this->aMessage === null && ($this->message_id !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aMessage->addMessageMedias($this);
			 */
		}
	...
	public function getMedia(PropelPDO $con = null)
	{
		if ($this->aMedia === null && ($this->media_id !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aMedia->addMessageMedias($this);
			 */
		}
		return $this->aMedia;
	}
	...
	{
		return (string) $this->exportTo(MessageMediaPeer::DEFAULT_STRING_FORMAT);
	}
