...
abstract class BaseGroupPeer {
	...
	const CLASS_DEFAULT = 'default.Group';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'OwnerId', 'Name', 'Title', 'Comment', 'Date', 'Status', 'Domain', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'ownerId', 'name', 'title', 'comment', 'date', 'status', 'domain', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::OWNER_ID, self::NAME, self::TITLE, self::COMMENT, self::DATE, self::STATUS, self::DOMAIN, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'OWNER_ID', 'NAME', 'TITLE', 'COMMENT', 'DATE', 'STATUS', 'DOMAIN', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'owner_id', 'name', 'title', 'comment', 'date', 'status', 'domain', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'OwnerId' => 1, 'Name' => 2, 'Title' => 3, 'Comment' => 4, 'Date' => 5, 'Status' => 6, 'Domain' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'ownerId' => 1, 'name' => 2, 'title' => 3, 'comment' => 4, 'date' => 5, 'status' => 6, 'domain' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::OWNER_ID => 1, self::NAME => 2, self::TITLE => 3, self::COMMENT => 4, self::DATE => 5, self::STATUS => 6, self::DOMAIN => 7, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'OWNER_ID' => 1, 'NAME' => 2, 'TITLE' => 3, 'COMMENT' => 4, 'DATE' => 5, 'STATUS' => 6, 'DOMAIN' => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'owner_id' => 1, 'name' => 2, 'title' => 3, 'comment' => 4, 'date' => 5, 'status' => 6, 'domain' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(GroupPeer::OWNER_ID);
			...
			$criteria->addSelectColumn(GroupPeer::DATE);
			$criteria->addSelectColumn(GroupPeer::STATUS);
			$criteria->addSelectColumn(GroupPeer::DOMAIN);
		} else {
