...
abstract class BaseLanguagePeer {
	...
	const CLASS_DEFAULT = 'default.Language';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Code', 'Revision', 'Dictionary', 'Status', 'Domain', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'code', 'revision', 'dictionary', 'status', 'domain', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::CODE, self::REVISION, self::DICTIONARY, self::STATUS, self::DOMAIN, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'CODE', 'REVISION', 'DICTIONARY', 'STATUS', 'DOMAIN', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'code', 'revision', 'dictionary', 'status', 'domain', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Code' => 1, 'Revision' => 2, 'Dictionary' => 3, 'Status' => 4, 'Domain' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'code' => 1, 'revision' => 2, 'dictionary' => 3, 'status' => 4, 'domain' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::CODE => 1, self::REVISION => 2, self::DICTIONARY => 3, self::STATUS => 4, self::DOMAIN => 5, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'CODE' => 1, 'REVISION' => 2, 'DICTIONARY' => 3, 'STATUS' => 4, 'DOMAIN' => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'code' => 1, 'revision' => 2, 'dictionary' => 3, 'status' => 4, 'domain' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(LanguagePeer::REVISION);
			$criteria->addSelectColumn(LanguagePeer::DICTIONARY);
			$criteria->addSelectColumn(LanguagePeer::STATUS);
			$criteria->addSelectColumn(LanguagePeer::DOMAIN);
		} else {
			$criteria->addSelectColumn($alias . '.ID');
			$criteria->addSelectColumn($alias . '.CODE');
			$criteria->addSelectColumn($alias . '.REVISION');
			$criteria->addSelectColumn($alias . '.DICTIONARY');
