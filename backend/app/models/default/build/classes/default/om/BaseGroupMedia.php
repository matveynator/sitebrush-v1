...
/**
 * Base class that represents a row from the 'group_media' table.
 *
 * 
 *
 * @package    propel.generator.default.om
 */
abstract class BaseGroupMedia extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'GroupMediaPeer';
	 ...
	 * @return     GroupMedia The current object (for fluent API support)
	 */
	public function setGroupId($v)
	{
		...
		if ($this->group_id !== $v) {
			$this->group_id = $v;
			$this->modifiedColumns[] = GroupMediaPeer::GROUP_ID;
		}
	...
	public function setMediaId($v)
	{
		...
		if ($this->media_id !== $v) {
			$this->media_id = $v;
			$this->modifiedColumns[] = GroupMediaPeer::MEDIA_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = GroupMediaPeer::NUM_COLUMNS - GroupMediaPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating GroupMedia object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = Propel::getConnection(GroupMediaPeer::DATABASE_NAME, Propel::CONNECTION_READ);
		}

		// We don't need to alter the object instance pool; we're just modifying this instance
		// already in the pool.

		$stmt = GroupMediaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = Propel::getConnection(GroupMediaPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
		}
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				GroupMediaPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$affectedRows += GroupMediaPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = GroupMediaPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = GroupMediaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['GroupMedia'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['GroupMedia'][serialize($this->getPrimaryKey())] = true;
		$keys = GroupMediaPeer::getFieldNames($keyType);
		$result = array(
	...
	{
		$criteria = new Criteria(GroupMediaPeer::DATABASE_NAME);

		if ($this->isColumnModified(GroupMediaPeer::GROUP_ID)) $criteria->add(GroupMediaPeer::GROUP_ID, $this->group_id);
		if ($this->isColumnModified(GroupMediaPeer::MEDIA_ID)) $criteria->add(GroupMediaPeer::MEDIA_ID, $this->media_id);
	...
	{
		$criteria = new Criteria(GroupMediaPeer::DATABASE_NAME);
		$criteria->add(GroupMediaPeer::GROUP_ID, $this->group_id);
		$criteria->add(GroupMediaPeer::MEDIA_ID, $this->media_id);
	...
	{
		return (null === $this->getGroupId()) && (null === $this->getMediaId());
	}
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of GroupMedia (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     GroupMedia Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     GroupMediaPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new GroupMediaPeer();
		}
		return self::$peer;
	}
	...
	public function getGroup(PropelPDO $con = null)
	{
		if ($this->aGroup === null && ($this->group_id !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aGroup->addGroupMedias($this);
			 */
		}
		return $this->aGroup;
	}
	...
	public function getMedia(PropelPDO $con = null)
	{
		if ($this->aMedia === null && ($this->media_id !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aMedia->addGroupMedias($this);
			 */
		}
		return $this->aMedia;
	}
	...
	{
		return (string) $this->exportTo(GroupMediaPeer::DEFAULT_STRING_FORMAT);
	}
