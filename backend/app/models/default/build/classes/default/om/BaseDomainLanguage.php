...
/**
 * Base class that represents a row from the 'domain_language' table.
 *
 * 
 *
 * @package    propel.generator.default.om
 */
abstract class BaseDomainLanguage extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'DomainLanguagePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        DomainLanguagePeer
	 */
	 ...
	 * @return     DomainLanguage The current object (for fluent API support)
	 */
	public function setDomainId($v)
	{
		...
		if ($this->domain_id !== $v) {
			$this->domain_id = $v;
			$this->modifiedColumns[] = DomainLanguagePeer::DOMAIN_ID;
		}
	...
	public function setLanguageId($v)
	{
		...
		if ($this->language_id !== $v) {
			$this->language_id = $v;
			$this->modifiedColumns[] = DomainLanguagePeer::LANGUAGE_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->domain_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			...
			return $startcol + 2; // 2 = DomainLanguagePeer::NUM_COLUMNS - DomainLanguagePeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating DomainLanguage object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = DomainLanguagePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				DomainLanguagePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$affectedRows += DomainLanguagePeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = DomainLanguagePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = DomainLanguagePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['DomainLanguage'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['DomainLanguage'][serialize($this->getPrimaryKey())] = true;
		$keys = DomainLanguagePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getDomainId(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setDomainId($arr[$keys[0]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(DomainLanguagePeer::DOMAIN_ID)) $criteria->add(DomainLanguagePeer::DOMAIN_ID, $this->domain_id);
		if ($this->isColumnModified(DomainLanguagePeer::LANGUAGE_ID)) $criteria->add(DomainLanguagePeer::LANGUAGE_ID, $this->language_id);
	...
	{
		$criteria = new Criteria(DomainLanguagePeer::DATABASE_NAME);
		$criteria->add(DomainLanguagePeer::DOMAIN_ID, $this->domain_id);
		$criteria->add(DomainLanguagePeer::LANGUAGE_ID, $this->language_id);
	...
	{
		return (null === $this->getDomainId()) && (null === $this->getLanguageId());
	}
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of DomainLanguage (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     DomainLanguage Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     DomainLanguagePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new DomainLanguagePeer();
		}
		return self::$peer;
	}
	...
	public function getDomain(PropelPDO $con = null)
	{
		if ($this->aDomain === null && ($this->domain_id !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aDomain->addDomainLanguages($this);
			 */
		}
		return $this->aDomain;
	}
	...
	public function getLanguage(PropelPDO $con = null)
	{
		if ($this->aLanguage === null && ($this->language_id !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aLanguage->addDomainLanguages($this);
			 */
		}
	...
	{
		return (string) $this->exportTo(DomainLanguagePeer::DEFAULT_STRING_FORMAT);
	}
