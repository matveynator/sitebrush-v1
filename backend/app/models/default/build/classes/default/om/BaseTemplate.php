...
abstract class BaseTemplate extends BaseObject  implements Persistent
{
	...
	public function setDomain($v)
	{
		...
		if ($this->domain !== $v) {
			$this->domain = $v;
			$this->modifiedColumns[] = TemplatePeer::DOMAIN;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = TemplatePeer::NUM_COLUMNS - TemplatePeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(TemplatePeer::ID) ) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TemplatePeer::DOMAIN)) $criteria->add(TemplatePeer::DOMAIN, $this->domain);
	 ...
	 * @return     PropelCollection|array PostTemplate[] List of PostTemplate objects
	 */
	public function getPostTemplatesJoinPost($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = PostTemplateQuery::create(null, $criteria);
	 ...
	 *
	 * @param      Post $post The PostTemplate object to relate
	 * @return     void
	 */
