...
/**
 * This class defines the structure of the 'post_message' table.
 *
 *
 *
 ...
 */
class PostMessageTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'default.map.PostMessageTableMap';
	...
	{
	  // attributes
		$this->setName('post_message');
		$this->setPhpName('PostMessage');
		$this->setClassname('PostMessage');
