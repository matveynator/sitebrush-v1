...
function ShowLastPosts($OrderBy="Date")
{
//echo "<pre>";
//print_r($_SESSION);
//die;
...
//  $TotalPages = ceil($BlogPostsAmmount / $configuration['PagerAmmountPerPage']);
  ...
  $CurrentTime=time();
  $BlogPosts = GetLastNPosts($CurrentTime, $configuration['PagerAmmountPerPage'], "Blog", $OrderBy);
...
//    $PostsToBrowse=GetLastNAuthorPosts($Author, $FinishTime, 50, "Blog",$OrderBy);
    ...
    PWDRF(FALSE,$CurrentTime,10,"Blog",$OrderBy);
